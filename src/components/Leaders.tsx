            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                ...
                <div className="flex gap-6 text-sm font-bold text-gray-400">
                  <span className="text-gray-900 pb-1 border-b-[3px] border-[#0b4d21] cursor-pointer">Choudhary Charan Singh</span>
                  <span className="cursor-pointer hover:text-gray-600 transition-colors pb-1">Choudhary Sunil Singh</span>
                </div>
              </div>
