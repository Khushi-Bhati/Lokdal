        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100 mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {["Farmers", "Justice", "Democracy", "Education", "Unity"].map((tag) => (
                <button key={tag} className="px-4 py-1.5 bg-gray-100 text-gray-600 hover:bg-gray-200 rounded-full text-sm font-bold transition-colors">{tag}</button>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
            {ideologies.map((item, idx) => (
              <div key={idx} className="bg-white border border-gray-100 hover:border-green-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-all group">
